...
async function main() {
    ...
    try {
        ...
        const redLightTD = allTDs.find((td) => td.title === "virtualLightRed");
        ...
        debugLog("virtualLightRed lightState href:", hrefFor(redLightTD, "properties", "lightState"));
        // Consume Things
        ...
        const checkInterval = setInterval(async () => {
            try {
                ...
                if (DEBUG && now - lastHeartbeat >= 2000) {
                    debugLog("objectPresence:", isPresent, "redCubeDetected:", redCubeDetected);
                    lastHeartbeat = now;
                }
